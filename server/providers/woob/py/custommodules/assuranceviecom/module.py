...
from .browser import AssuranceVieCom


__all__ = ['AssuranceVieComModule']


class AssuranceVieComModule(Module, CapBankWealth):
    NAME = 'assuranceviecom'
    MAINTAINER = 'Duchesne Lucas'
    EMAIL = 'lucasduchesne@gmail.com'
    VERSION = '1.0'
    LICENSE = 'AGPLv3+'
    DESCRIPTION = u'Assurancevie.com'
